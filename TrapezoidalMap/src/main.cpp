...
int main(int, char** argv) {
	...
	cout << "generate" << endl;;
	int nok = Mesh::generateMesh("mesh.obj", mesh, size);
	...
	// PARTE 2 - Cria o mapa trapezoidal
	...
	Vertex *v = new Vertex(400,700);
	Edge *newEdge1, *newEdge2;
	splitEdge(mesh.edges[0], v, newEdge1, newEdge2);
	mesh.edges[0] = newEdge1;
